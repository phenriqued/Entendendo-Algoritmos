 ...
 * o array tem um tamanho fixado na sua Instanciação, cada elemento num array é fixado a um indice, assim, desempenhando em funções de leitura, contundo obtendo um
